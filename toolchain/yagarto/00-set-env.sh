...
tar -xjvf download/$GCC_CORE_SRC.tar.bz2 || { echo "Error extracting "$GCC_CORE_SRC; exit; }

echo "Extracting $GCC_GPP_SRC"
tar -xjvf download/$GCC_GPP_SRC.tar.bz2 || { echo "Error extracting "$GCC_GPP_SRC; exit; }
